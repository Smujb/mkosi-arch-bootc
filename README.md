...
This image is extremely minimalist and designed to be used as a template for making your own. It comes with a kernel, bootc, an editor, setup in place for registering an admin user account using systemd-homed and functional run0 for privilege escalation. Multilib is enabled, but nothing is installed from it.
